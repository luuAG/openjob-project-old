...
public class ExportController {
    ...
    public ResponseEntity<?> exportAcceptedCv(@Valid @RequestBody ExportDTO body) throws IOException {
        ...
        String filename = "";
        Workbook wb;
        try (InputStream is = new FileInputStream(new File("").getAbsolutePath() + "/openjob-parent-api/openjob-web-api/src/main/resources/templates/export_cv_template.xlsx")){
