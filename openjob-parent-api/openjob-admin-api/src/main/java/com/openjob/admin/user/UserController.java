...
public class UserController {
    ...
    public ResponseEntity<Admin> getAdminUser(@PathVariable final String id) throws AdminUserNotFound {
        ...
        Optional<Admin> admin = userService.get(id);
        if (admin.isPresent())
    ...
    public ResponseEntity<Collection<Admin>> getAdminUserByPage(
        ...
        return ResponseEntity.ok(userService.searchByPage(page, size, keyword, isActive));
    }
    ...
    public ResponseEntity<Admin> createAdminUser(@Valid @RequestBody final Admin admin) throws SQLException {
        ...
        Admin savedAdmin = userService.save(admin);
    ...
    public ResponseEntity<Admin> updateAdmin(@Valid @RequestBody final Admin admin) throws SQLException {
        ...
        if (userService.isExisting(admin.getId())){
            savedAdmin = userService.save(admin);
            savedAdmin.setPassword("hidden-for-security");
        }
    ...
    public void refreshToken(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if (Objects.nonNull(authorizationHeader) && authorizationHeader.startsWith("Bearer ")){
            try{
                ...
                Optional<Admin> admin = userService.findByUsername(username);
                if(admin.isPresent()){
